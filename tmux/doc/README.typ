...
#align(center, text()[
  #table(columns: 4, align: left,
    ...
    [13], [Ctrl S], [Alt h], [Split a screen left],
    [14], [Ctrl S], [Alt j], [Split a screen down],
    [15], [Ctrl S], [Alt k], [Split a screen up],
    [16], [Ctrl S], [Alt l], [Split a screen right],
    [17], [Ctrl S], [left], [Adjust the size of screen left(continuously)],
    [18], [Ctrl S], [down], [Adjust the size of screen down(continuously)],
    [19], [Ctrl S], [up], [Adjust the size of screen up(continuously)],
    [20], [Ctrl S], [right], [Adjust the size of screen right(continuously)],
  )
])
